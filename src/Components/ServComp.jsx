    ...
    <div>
      <section className="mx-auto bg-[#f5f5f0] px-4 py-8 sm:px-6 lg:px-16 flex justify-center items-center">
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-12 gap-8 place-items-center backdrop-blur-md md:border md:border-white/10 rounded-md md:p-8 shadow-xl hover:shadow-2xl transition-all duration-300 max-w-[1600px] w-full"
        >
          {/* Image */}
          <motion.div
          ...
          <motion.div
            ...
            viewport={{ once: false, amount: 0.4 }}
            className="md:col-span-7 flex flex-col items-center text-center space-y-6 p-6"
          >
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 text-lg text-[#b18e63] font-medium"
            >
              <OrderPopup
                triggerText={
